...
<!-- VARIANT 11: CPI extension function (side effect) inside message -->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        ...
        <xsl:message>Test 11: Header set result = <xsl:value-of select="cpi:setHeader($exchange, 'debug-marker', 'from-message')"/></xsl:message>
