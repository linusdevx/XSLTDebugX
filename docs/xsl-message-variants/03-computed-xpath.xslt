...
<!-- VARIANT 03: Message with computed XPath expression -->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        ...
        <xsl:message>Test 3: Total price = <xsl:value-of select="sum(/Products/Product/Price) * number($quantity)"/></xsl:message>
